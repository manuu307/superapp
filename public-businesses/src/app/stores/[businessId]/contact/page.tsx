    ...
    <div className="container mx-auto p-4">
      ...
      <div className="my-4">
        ...
        <table className="table-auto w-full">
          ...
          <tbody>
            {business.openDaysHours && business.openDaysHours.map((day, index) => (
              <tr key={index}>
      ...
      {business.location && (
        <div>
          ...
          <iframe
            ...
            loading="lazy"
            allowFullScreen
            src={`https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=${business.location.latitude},${business.location.longitude}`}>
          </iframe>
        </div>
      )}
    </div>
